...
@section('title')
@parent
{{ trans('sanatorium/status::statuses/common.title') }}
@stop
...
{{ Asset::queue('index', 'sanatorium/status::statuses/js/index.js', 'platform') }}
...
<section class="panel panel-default panel-grid">
		...
		<nav class="navbar navbar-default navbar-actions">
			...
			<div class="container-fluid">
				...
				<div class="navbar-header">
					...
					<span class="navbar-brand">{{{ trans('sanatorium/status::statuses/common.title') }}}</span>
				...
				<div class="collapse navbar-collapse" id="actions">
					...
					<ul class="nav navbar-nav navbar-left">
						...
						<li class="primary">
							<a href="{{ route('admin.sanatorium.status.statuses.create') }}" data-toggle="tooltip" data-original-title="{{{ trans('action.create') }}}">
					...
					{{-- Grid: Filters --}}
					<form class="navbar-form navbar-right" method="post" accept-charset="utf-8" data-search data-grid="status" role="form">
						...
						<div class="input-group">
							...
							<span class="input-group-btn">
								...
								<ul class="dropdown-menu" role="menu">
									...
									<li>
										<a data-grid="status" data-filter="enabled:1" data-label="enabled::{{{ trans('common.all_enabled') }}}" data-reset>
											<i class="fa fa-eye"></i> {{{ trans('common.show_enabled') }}}
										</a>
									</li>

									<li>
										<a data-toggle="tooltip" data-placement="top" data-original-title="" data-grid="status" data-filter="enabled:0" data-label="enabled::{{{ trans('common.all_disabled') }}}" data-reset>
							...
							<span class="input-group-btn">
								...
								<button class="btn btn-default" data-grid="status" data-reset>
	...
	<div class="panel-body">
		...
		<div class="btn-toolbar" role="toolbar" aria-label="data-grid-applied-filters">
			...
			<div id="data-grid_applied" class="btn-group" data-grid="status"></div>
	...
	<div class="table-responsive">
		...
		<table id="data-grid" class="table table-hover" data-source="{{ route('admin.sanatorium.status.statuses.grid') }}" data-grid="status">
			<thead>
				<tr>
					<th><input data-grid-checkbox="all" type="checkbox"></th>
					<th class="sortable" data-sort="id">{{{ trans('sanatorium/status::statuses/model.general.id') }}}</th>
					<th class="sortable" data-sort="name">{{{ trans('sanatorium/status::statuses/model.general.name') }}}</th>
					<th class="sortable" data-sort="css_class">{{{ trans('sanatorium/status::statuses/model.general.css_class') }}}</th>
					<th></th>
				</tr>
			</thead>
			<tbody></tbody>
	...
	<footer class="panel-footer clearfix">
		...
		{{-- Grid: Pagination --}}
		<div id="data-grid_pagination" data-grid="status"></div>

	</footer>

	{{-- Grid: templates --}}
	@include('sanatorium/status::statuses/grid/index/results')
	@include('sanatorium/status::statuses/grid/index/pagination')
	@include('sanatorium/status::statuses/grid/index/filters')
	@include('sanatorium/status::statuses/grid/index/no_results')

</section>

@if (config('platform.app.help'))
	@include('sanatorium/status::statuses/help')
@endif
